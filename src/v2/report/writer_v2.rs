...
fn get_api_value(values: &ReportValues, key: super::registry::ApiKey) -> CellValue {
    ...
    match key {
        ...
        ApiKey::ExchangeRateInput => values
            ...
            .unwrap_or(CellValue::Empty),
        // TODO: Weitere API-Keys implementieren wenn ReportValues erweitert wird
        _ => CellValue::Empty,
    }
}

/// Schreibt alle Formel-Zellen aus der Registry
fn write_cells_from_registry(
    ...
    // Nur Formel-Zellen schreiben (API-Zellen werden von den Sections geschrieben)
