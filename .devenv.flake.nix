{
  ...
  version = "1.11.2";
  system = "x86_64-linux";
  devenv_root = "/home/ardit/repos/Arbeit/KMW-FB_Rust/src_rust";
  project_input_ref = "path:/home/ardit/repos/Arbeit/KMW-FB_Rust/src_rust";
  devenv_dotfile = "/home/ardit/repos/Arbeit/KMW-FB_Rust/src_rust/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-723c11a";
  ...
  hostname = "nixos";
  username = "ardit";
  git_root = "/home/ardit/repos/Arbeit/KMW-FB_Rust/src_rust";
  secretspec = null;
};
    in
    {
